...
export default class ActionAdverse extends foundry.abstract.TypeDataModel {
  /** @override */
  static LOCALIZATION_PREFIXES = ["PENOMBRE.ActionAdverse"]
  ...
  async _preCreate(data, options, user) {
    ...
    if (!stats.duplicateSource && !stats.compendiumSource && !stats.exportSource) {
      ...
      if (!foundry.utils.hasProperty(data, "img")) {
        updates.img = "systems/penombre/assets/icons/actionAdverse.png"
      }
    }
